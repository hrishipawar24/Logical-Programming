/*
Write A Program which Displays Smallest Digit of all elements in Singly Linked List
...
void DisplaySamllDigit(PPNODE head)
{
    PNODE temp = *head;
    int iDigit = 0, iNo = 0, iMin = 0;
    printf("The Smallest Digit of Elements of the Linked List are :\n");
...
{   
    ...
    { 
        ...
        printf("9 : Display Samllest Digit of Each Element of the Linked List\n");
        printf("10 : Exit\n");

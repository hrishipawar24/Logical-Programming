/*
Write A Program which Displays Largest Digit of all elements in Singly Linked List
...
void DisplayLargestDigit(PPNODE head)
{
    PNODE temp = *head;
    int iDigit = 0, iNo = 0, iLarge = 0;
    printf("The Largest Digit of Elements of the Linked List are :\n");
...
{   
    ...
    { 
        ...
        printf("9 : Display Largest Digit of Each Element of the Linked List\n");
        printf("10 : Exit\n");

/*
Write A Program which Reverses Each Element in Singly Linked List
...
void DisplayRev(PPNODE head)
{
    PNODE temp = *head;
    int iRev = 0, iDigit = 0;
    printf("The Reverse Elements of the Linked List are :\n");
...
{   
    ...
    { 
        ...
        printf("9 : Display Reverse Elements of the Linked List\n");
        printf("10 : Exit\n");

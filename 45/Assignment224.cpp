...
Promblem Statement :   Write A Program which return's Second Largest Element in the Linked List

Example : 
Input Linked List : | 110 | -> | 220 | -> | 320 | -> | 240 |
Output :    240
*/
...
{   
    ...
    while(temp != NULL)
    {
        if(temp -> data > iSecondLarge && temp -> data != iLarge)
        {
            iSecondLarge = temp -> data;
        }
        temp = temp -> next;
    }
...
{   
    ...
    do
    {
        ...
        cout<<"9 : Second Largest Element in the linked list\n";
        cout<<"10 : Exit\n";

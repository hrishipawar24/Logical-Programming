...
Promblem Statement :   Write A Program which Displays all the Perfect Numbers of the Linked List

Example : 
Input Linked List : | 11 | -> | 28 | -> | 17 | -> | 41 | -> | 6 | -> | 89 |
Output :    6   28
Note : Insert the Data Using InsertFirst(Recommended)
*/
...
{   
    ...
    do
    {
        ...
        cout<<"9 : Display Perfect Numbers in the Linked List\n";
        cout<<"10 : Exit\n";
